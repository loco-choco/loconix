...
in mkWindowsApp rec {
  ...
  src = fetchurl {
    url = "https://content.u-blox.com/sites/default/files/2022-09/u-centersetup_v${version}.zip";
    sha256 = "sha256-agL0GU5FzeMtYoBGb7+SF3DZ0GVPC4o1XQRX7/Gi6UQ=";
  };
  ...
  winAppInstall = ''
    ...
    mkdir -p "$d"
    unzip ${src} -d "$d"
    $WINE "$d/u-center_v${version}.exe" /S
  '';
  ...
  winAppRun = ''
    $WINE "$WINEPREFIX/drive_c/Program Files (x86)/u-blox/u-center_v${version}/u-center.exe"
  '';
  ...
  in [
    (makeDesktopItem {
      ...
      exec = pname;
      icon = pname;
      desktopName = "u-center";
      genericName = "u-center";
      categories = ["Utility"];
    })
  ];
  ...
  desktopIcon = makeDesktopIcon {
    name = "ucenter";
    src = fetchurl {
      url = "https://www.u-blox.com/icons/position_time_product_icon.svg";
      sha256 = "sha256-HZJkltXhHNaFdtJCrrafgbiFErBZfhsyxRJygadR7W8=";
    };
  };

  meta = with lib; {
    description = "GNSS evaluation software for Windows.";
    homepage = "https://www.u-blox.com/en/product/u-center";
